...
- `${CLAUDE_PLUGIN_ROOT}/skills/specialist/references/captive-formation-831b.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/specialist/references/current-legislation.md` — check its as-of date; if older than 90 days or missing the fact you need, verify against primary sources yourself.
