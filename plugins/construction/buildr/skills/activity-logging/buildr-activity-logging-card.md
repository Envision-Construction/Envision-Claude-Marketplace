## Description: <br>
Log calls, meetings, and notes into Buildr against the right entity (contact, deal, or company). <br>
...
## Use Case: <br>
Employees at Envision Construction use this skill to record CRM activity — calls, meetings, and notes — against the correct contact, deal, or company in Buildr immediately after a conversation. <br>
...
**Output Format:** [Markdown confirmation of the logged activity] <br>
