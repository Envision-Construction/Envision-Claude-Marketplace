...
| Strategy, value creation, EBITDA/cash impact, exit posture | **main session** invokes `Skill(pe-executive:pe-executive-mindset)` (when that plugin is installed) — never delegated to insurance agents | — |
