...
Read `${CLAUDE_PLUGIN_ROOT}/skills/insurance-specialist/references/forensic-research-protocol.md`. It is your operating manual — source hierarchy, canonical URL patterns per jurisdiction, verification rules, citation format.
