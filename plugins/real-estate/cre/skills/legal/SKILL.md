...
| CRE Insurance Coordinator | `skills/cre-insurance-coordinator.md` | User needs to verify insurance requirements from lender and PSA — coverage types, limits, gap analysis, premium estimates |
...
**CRE Insurance Coordinator** — Verifies: property coverage, general liability, flood, windstorm, umbrella/excess, business interruption, builder's risk (if renovating). Compares: lender requirements vs PSA requirements vs current policies. Outputs: gap analysis with premium estimates.
